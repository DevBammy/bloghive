    ...
    <section className={styles.aboutPage}>
      ...
      {/* <>
        ...
        <p>
          ...
          distraction-free space where anyone can write, publish, and connect
          with an audience that values substance over noise.
        </p>

        <h2>What We Offer</h2>
        <ol>
          <li>
            <strong>Powerful Writing Tools:</strong> a seamless editor that lets
            your ideas flow without friction.
          </li>
          <li>
            <strong>Community-Centric Experience:</strong> follow your favorite
            writers, engage in meaningful discussions, and discover content that
            aligns with your passions.
          </li>
          <li>
            <strong>Built for Growth:</strong> whether you're blogging as a
            hobby or building a personal brand, BlogHive helps you grow your
            voice and visibility.
          </li>
          <li>
            <strong>Secure & Scalable:</strong> with reliable hosting, fast
            performance, and robust security, you focus on writing—we handle the
            rest.
          </li>
        </ol>
        ...
        <p>
          ...
          contributor adds value to the collective— creating a space that's
          always evolving, always alive.
        </p>
